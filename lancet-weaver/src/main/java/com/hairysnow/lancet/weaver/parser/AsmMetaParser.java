...
import com.hairysnow.lancet.base.annotations.ClassOf;
import com.hairysnow.lancet.base.annotations.ImplementedInterface;
...
import com.hairysnow.lancet.weaver.exception.LoadClassException;
import com.hairysnow.lancet.weaver.exception.UnsupportedAnnotationException;
import com.hairysnow.lancet.weaver.graph.Graph;
import com.hairysnow.lancet.weaver.log.Log;
import com.hairysnow.lancet.weaver.meta.ClassMetaInfo;
import com.hairysnow.lancet.weaver.meta.MethodMetaInfo;
import com.hairysnow.lancet.weaver.parser.anno.AcceptAny;
import com.hairysnow.lancet.weaver.parser.anno.ClassOfAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.DelegateAcceptableAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.GatheredAcceptableAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.ImplementedInterfaceAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.InsertAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.NameRegexAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.ProxyAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.TargetClassAnnoParser;
import com.hairysnow.lancet.weaver.parser.anno.TryCatchAnnoParser;
        ...
        private List<AnnotationMeta> nodesToMetas(List<AnnotationNode> nodes) {
            ...
            return nodes.stream().map(c -> {
                if (!parser.accept(c.desc)) {
                    Log.e("UnsupportedAnnotationException: "+c.desc + " is not supported");
