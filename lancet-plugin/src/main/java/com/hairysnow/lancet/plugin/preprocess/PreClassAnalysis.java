...
import com.hairysnow.lancet.plugin.LocalCache;
import com.hairysnow.lancet.plugin.TransformContext;
import com.hairysnow.lancet.plugin.Util;
import com.hairysnow.lancet.plugin.context.ClassFetcher;
        ...
        public void onClassFetch(QualifiedContent content, Status status, String relativePath, byte[] bytes) {
            if (relativePath.endsWith(".class")) {
                ...
                if (partial && result.isHookClass) {
                    partial = false;
                    Log.e("ParseFailureException: "+result.toString());
